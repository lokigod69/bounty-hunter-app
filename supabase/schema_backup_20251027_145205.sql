...
\restrict gWeewqeOi2E2Xx2hWWC0NuyA0JM2v9bB7viXPPuqXLyOVz7c9ahk4FGBSH0KK7E
...
--
-- Name: collected_rewards Creators can view collections of their rewards; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Creators can view collections of their rewards" ON "public"."collected_rewards" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."rewards_store"
  WHERE (("rewards_store"."id" = "collected_rewards"."reward_id") AND ("rewards_store"."creator_id" = "auth"."uid"())))));
...
--
-- Name: collected_rewards Users can collect rewards; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can collect rewards" ON "public"."collected_rewards" FOR INSERT TO "authenticated" WITH CHECK (("collector_id" = "auth"."uid"()));
...
CREATE POLICY "Users can view own collected rewards" ON "public"."collected_rewards" FOR SELECT TO "authenticated" USING (("collector_id" = "auth"."uid"()));
...
--
-- Name: collected_bounties cb_owner_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "cb_owner_select" ON "public"."collected_bounties" FOR SELECT TO "authenticated" USING (("collector_id" = "auth"."uid"()));


--
-- Name: collected_bounties cb_owner_write; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "cb_owner_write" ON "public"."collected_bounties" TO "authenticated" USING (("collector_id" = "auth"."uid"())) WITH CHECK (("collector_id" = "auth"."uid"()));


--
-- Name: collected_bounties; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: marketplace_bounties; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."marketplace_bounties" ENABLE ROW LEVEL SECURITY;

--
-- Name: marketplace_bounties mb_owner_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "mb_owner_select" ON "public"."marketplace_bounties" FOR SELECT TO "authenticated" USING (("creator_id" = "auth"."uid"()));


--
-- Name: marketplace_bounties mb_owner_write; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "mb_owner_write" ON "public"."marketplace_bounties" TO "authenticated" USING (("creator_id" = "auth"."uid"())) WITH CHECK (("creator_id" = "auth"."uid"()));
...
\unrestrict gWeewqeOi2E2Xx2hWWC0NuyA0JM2v9bB7viXPPuqXLyOVz7c9ahk4FGBSH0KK7E
