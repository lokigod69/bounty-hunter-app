-- Proposal 004: Harden SECURITY DEFINER Functions
-- Adds `SET search_path = public, pg_temp` to all SECURITY DEFINER functions
-- Prevents search_path poisoning attacks where malicious users create
-- functions/tables in their own schema to hijack unqualified references
